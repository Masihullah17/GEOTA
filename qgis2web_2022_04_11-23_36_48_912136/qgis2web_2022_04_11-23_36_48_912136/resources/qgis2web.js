...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32644',
            extent: [8898609.436900, 1512593.641704, 8912997.507102, 1528907.723800],
            units: 'm'})
    })
});
...
map.getView().fit([8893708.726900, 1512189.973800, 8917880.146900, 1529315.473800], map.getSize());
